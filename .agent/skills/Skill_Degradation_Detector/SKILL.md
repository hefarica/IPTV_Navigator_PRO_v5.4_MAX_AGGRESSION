...
description: Mi capacidad instalada para dominar Degradation Detector y telemetría avanzada.
---
# Skill: Skill_Degradation_Detector

## Identity
Yo soy el experto interno de Antigravity en la especialización de Degradation Detector.
