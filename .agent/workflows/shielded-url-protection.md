---
name: shielded-url-protection
description: "Workflow BLOQUEANTE que se activa ANTES de cualquier modificación a URLs de canales M3U8. Impide que se transformen URLs internas con /shield/ — el shielding lo hace el WireGuard tunnel, NO la URL."
---
