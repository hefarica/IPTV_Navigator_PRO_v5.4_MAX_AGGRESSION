...
description: Mi capacidad instalada para dominar RealTime Event Aggregator y telemetría avanzada.
---
# Skill: Skill_RealTime_Event_Aggregator

## Identity
Yo soy el experto interno de Antigravity en la especialización de RealTime Event Aggregator.
