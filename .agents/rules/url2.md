...
```bash
python3.11 /home/ubuntu/skills/iptv-m3u8-e2e-auditor/scripts/analyze_playlist.py <playlist.m3u8> <output_dir>
python3.11 /home/ubuntu/skills/iptv-m3u8-e2e-auditor/scripts/probe_urls.py <output_dir>/unique_urls.csv <output_dir> [max_workers]
python3.11 /home/ubuntu/skills/iptv-m3u8-e2e-auditor/scripts/correlate_health.py <output_dir>/channel_structural_summary.csv <output_dir>/probe_results.csv <output_dir>
```
