...
description: Mi capacidad instalada para dominar Channel Inference Engine y telemetría avanzada.
---
# Skill: Skill_Channel_Inference_Engine

## Identity
Yo soy el experto interno de Antigravity en la especialización de Channel Inference Engine.
