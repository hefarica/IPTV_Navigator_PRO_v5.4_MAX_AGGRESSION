---
name: android-tv-ott-tivimate-tuning
description: ExoPlayer load control, ADB tuning directives, EXTVLCOPT/KODIPROP per-player, OTT Navigator + TiviMate-specific behaviours, Fire TV / Android TV / Shield-Tegra knobs.
specialist: S9
kind: anchor
---

# android-tv-ott-tivimate-tuning

## 1. Nombre de la skill
android-tv-ott-tivimate-tuning

## 2. Cuándo usarla
ExoPlayer load control, ADB tuning directives, EXTVLCOPT/KODIPROP per-player, OTT Navigator + TiviMate-specific behaviours, Fire TV / Android TV / Shield-Tegra knobs.

Anchored to specialist: **Android TV Player Engineer** (S-tag S9).
Mission: Android TV, Fire TV, ExoPlayer LoadControl, ADB injection, KODIPROP
