---
name: androidtv-onn-4k-tuner
description: Use when tuning ONN 4K specifics: hardware HEVC decoder, Always-On VPN routing, DNS over TLS.
specialist: S9
kind: satellite
...
## Cuándo usarla
Use when tuning ONN 4K specifics: hardware HEVC decoder, Always-On VPN routing, DNS over TLS.
