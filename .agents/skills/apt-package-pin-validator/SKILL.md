---
name: apt-package-pin-validator
description: Use when pinning apt packages via /etc/apt/preferences.d to prevent unsupervised upgrade breaking nginx/openresty/lua versions.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# apt-package-pin-validator

## Cuándo usarla
Use when pinning apt packages via /etc/apt/preferences.d to prevent unsupervised upgrade breaking nginx/openresty/lua versions.
