---
name: audio-bitrate-fps-channels-detector
description: Use when extracting audio sample rate / bit rate / channel layout from ffprobe.
specialist: S3
kind: satellite
parent: ffmpeg-ffprobe-validator
---

# audio-bitrate-fps-channels-detector

## Cuándo usarla
Use when extracting audio sample rate / bit rate / channel layout from ffprobe.
