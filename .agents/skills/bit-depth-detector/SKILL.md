---
name: bit-depth-detector
description: Use when detecting 8-bit vs 10-bit vs 12-bit content from ffprobe stream metadata (bits_per_raw_sample / pix_fmt).
specialist: S3
kind: satellite
...
## Cuándo usarla
Use when detecting 8-bit vs 10-bit vs 12-bit content from ffprobe stream metadata (bits_per_raw_sample / pix_fmt).
