---
name: bt2020-color-gamut-validator
description: Use when validating BT.2020 color primaries (color_primaries=9) for HDR content.
specialist: S4
kind: satellite
...
## Cuándo usarla
Use when validating BT.2020 color primaries (color_primaries=9) for HDR content.
