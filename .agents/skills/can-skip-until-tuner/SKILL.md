---
name: can-skip-until-tuner
description: Use when tuning CAN-SKIP-UNTIL (typically 6× target duration) to control how stale a delta-playlist can be.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when tuning CAN-SKIP-UNTIL (typically 6× target duration) to control how stale a delta-playlist can be.
