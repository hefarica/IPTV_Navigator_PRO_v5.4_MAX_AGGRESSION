...
description: Multi-file refactor with rollback, git surgery (stash/cherry-pick/revert), test orchestration, doctrine enforcement (omega-no-delete, no-touch-prod, cortex-mandatory), CLAUDE.md / GEMINI.md drift detection.
specialist: S13
kind: anchor
---
...
## 2. Cuándo usarla
Multi-file refactor with rollback, git surgery (stash/cherry-pick/revert), test orchestration, doctrine enforcement (omega-no-delete, no-touch-prod, cortex-mandatory), CLAUDE.md / GEMINI.md drift detection.

Anchored to specialist: **Claude Code Repo Surgeon** (S-tag S13).
Mission: Multi-file refactor, git surgery, doctrine enforcement
