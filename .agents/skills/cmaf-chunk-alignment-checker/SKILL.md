---
name: cmaf-chunk-alignment-checker
description: Use when verifying CMAF chunks across renditions are byte-aligned at the same wall-clock for seamless switching.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# cmaf-chunk-alignment-checker

## Cuándo usarla
Use when verifying CMAF chunks across renditions are byte-aligned at the same wall-clock for seamless switching.
