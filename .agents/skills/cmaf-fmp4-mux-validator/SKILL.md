---
name: cmaf-fmp4-mux-validator
description: Use when validating that fMP4 segments contain `styp`, `sidx` (optional), `moof`+`mdat` chunks per CMAF.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# cmaf-fmp4-mux-validator

## Cuándo usarla
Use when validating that fMP4 segments contain `styp`, `sidx` (optional), `moof`+`mdat` chunks per CMAF.
