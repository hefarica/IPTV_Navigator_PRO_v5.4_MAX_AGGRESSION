---
name: cmaf-mdat-trun-parser
description: Use when parsing CMAF media segment `moof/traf/trun` to enumerate sample sizes/durations and `mdat` payload offsets.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# cmaf-mdat-trun-parser

## Cuándo usarla
Use when parsing CMAF media segment `moof/traf/trun` to enumerate sample sizes/durations and `mdat` payload offsets.
