---
name: codec-quality-analyzer
description: Codec detection (HEVC/AVC/AV1), profile/level/bit-depth, HDR authenticity (PQ/HLG/DV), fake-4K detection, bitrate vs resolution sanity, VMAF/SSIM estimates
specialist: S3
kind: anchor
---

# codec-quality-analyzer

## 1. Nombre de la skill
codec-quality-analyzer

## 2. Cuándo usarla
Codec detection (HEVC/AVC/AV1), profile/level/bit-depth, HDR authenticity (PQ/HLG/DV), fake-4K detection, bitrate vs resolution sanity, VMAF/SSIM estimates

Anchored to specialist: **Video Codec Engineer** (S-tag S3).
Mission: Codecs, HEVC Main10, HDR pipelines, fake-4K, fallback ladders
