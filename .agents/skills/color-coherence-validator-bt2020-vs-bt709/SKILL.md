---
name: color-coherence-validator-bt2020-vs-bt709
description: Use when alerting on color space mismatch between codec metadata (bt2020) and declared video-range (SDR/bt709).
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# color-coherence-validator-bt2020-vs-bt709

## Cuándo usarla
Use when alerting on color space mismatch between codec metadata (bt2020) and declared video-range (SDR/bt709).
