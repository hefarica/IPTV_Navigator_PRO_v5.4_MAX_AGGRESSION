---
name: connection-keep-alive-vs-close-router
description: Use when routing Connection: keep-alive (long sessions) vs close (Xtream max_connections=1 upstreams).
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# connection-keep-alive-vs-close-router

## Cuándo usarla
Use when routing Connection: keep-alive (long sessions) vs close (Xtream max_connections=1 upstreams).
