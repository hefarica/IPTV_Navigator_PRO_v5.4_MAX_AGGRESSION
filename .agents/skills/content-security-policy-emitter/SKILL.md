---
name: content-security-policy-emitter
description: Use when emitting CSP (`default-src 'self'; media-src https: blob:`) for player iframe.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# content-security-policy-emitter

## Cuándo usarla
Use when emitting CSP (`default-src 'self'; media-src https: blob:`) for player iframe.
