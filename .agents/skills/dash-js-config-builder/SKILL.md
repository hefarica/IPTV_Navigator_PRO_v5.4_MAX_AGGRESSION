---
name: dash-js-config-builder
description: Use when building dash.js settings (streaming.lowLatencyEnabled, abr.useDefaultABRRules).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# dash-js-config-builder

## Cuándo usarla
Use when building dash.js settings (streaming.lowLatencyEnabled, abr.useDefaultABRRules).
