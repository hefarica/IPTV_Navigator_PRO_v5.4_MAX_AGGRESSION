---
name: delta-playlist-builder
description: Use when emitting delta playlists with `_HLS_skip=YES` query param honored, omitting older segments and emitting EXT-X-SKIP.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# delta-playlist-builder

## Cuándo usarla
Use when emitting delta playlists with `_HLS_skip=YES` query param honored, omitting older segments and emitting EXT-X-SKIP.
