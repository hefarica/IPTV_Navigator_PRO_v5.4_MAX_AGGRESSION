---
name: dns-dot-cloudflare-helper
description: Use when configuring DNS-over-TLS via systemd-resolved + Cloudflare 1.1.1.1#cloudflare-dns.com.
specialist: S8
kind: satellite
parent: vps-network-tcp-quic-tuning
---

# dns-dot-cloudflare-helper

## Cuándo usarla
Use when configuring DNS-over-TLS via systemd-resolved + Cloudflare 1.1.1.1#cloudflare-dns.com.
