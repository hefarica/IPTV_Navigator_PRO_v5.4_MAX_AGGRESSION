...
description: Use when detecting Dolby Vision profile (5/8.1/8.2/8.4/10) from `dvcC` box or BL stream signaling.
specialist: S4
kind: satellite
...
## Cuándo usarla
Use when detecting Dolby Vision profile (5/8.1/8.2/8.4/10) from `dvcC` box or BL stream signaling.
