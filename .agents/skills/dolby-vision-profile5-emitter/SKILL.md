---
name: dolby-vision-profile5-emitter
description: Use when emitting DV Profile 5 (single-layer IPT-PQ, no fallback). CODECS="dvh1.05.06".
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# dolby-vision-profile5-emitter

## Cuándo usarla
Use when emitting DV Profile 5 (single-layer IPT-PQ, no fallback). CODECS="dvh1.05.06".
