---
name: dolby-vision-profile8-emitter
description: Use when emitting DV Profile 8.1 (single-layer cross-compat with HDR10 fallback). CODECS="hvc1.2.4.L153.B0,dvh1.08.06".
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# dolby-vision-profile8-emitter

## Cuándo usarla
Use when emitting DV Profile 8.1 (single-layer cross-compat with HDR10 fallback). CODECS="hvc1.2.4.L153.B0,dvh1.08.06".
