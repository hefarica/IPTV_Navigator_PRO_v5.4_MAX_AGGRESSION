---
name: dolby-vision-profile81-emitter
description: Use when emitting DV Profile 8.1 HDR10 base layer + DV RPU for compat with HDR10 TVs.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# dolby-vision-profile81-emitter

## Cuándo usarla
Use when emitting DV Profile 8.1 HDR10 base layer + DV RPU for compat with HDR10 TVs.
