---
name: dolby-vision-profile82-emitter
description: Use when emitting DV Profile 8.2 SDR base layer + DV RPU for compat with SDR TVs.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# dolby-vision-profile82-emitter

## Cuándo usarla
Use when emitting DV Profile 8.2 SDR base layer + DV RPU for compat with SDR TVs.
