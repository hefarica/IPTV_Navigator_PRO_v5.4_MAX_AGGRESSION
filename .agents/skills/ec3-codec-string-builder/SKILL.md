---
name: ec3-codec-string-builder
description: Use when emitting `ec-3` for Dolby Digital Plus (E-AC-3) audio in HLS.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# ec3-codec-string-builder

## Cuándo usarla
Use when emitting `ec-3` for Dolby Digital Plus (E-AC-3) audio in HLS.
