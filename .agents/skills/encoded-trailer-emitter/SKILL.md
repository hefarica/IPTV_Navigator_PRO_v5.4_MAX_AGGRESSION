---
name: encoded-trailer-emitter
description: Use when emitting HTTP trailer headers (`Trailer: X-Stream-Stats`) for chunked-transfer LL-HLS responses.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# encoded-trailer-emitter

## Cuándo usarla
Use when emitting HTTP trailer headers (`Trailer: X-Stream-Stats`) for chunked-transfer LL-HLS responses.
