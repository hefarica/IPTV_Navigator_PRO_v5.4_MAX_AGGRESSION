...
description: Use when implementing /health endpoint returning 200 OK + JSON {status, version, uptime, deps}.
specialist: S7
kind: satellite
...
## Cuándo usarla
Use when implementing /health endpoint returning 200 OK + JSON {status, version, uptime, deps}.
