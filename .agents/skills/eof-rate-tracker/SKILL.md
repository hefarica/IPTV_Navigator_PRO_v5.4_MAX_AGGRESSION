---
name: eof-rate-tracker
description: Use when tracking `unexpected end of stream` rate (okhttp) — indicates toxic headers (Range, If-None-Match).
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when tracking `unexpected end of stream` rate (okhttp) — indicates toxic headers (Range, If-None-Match).
