---
name: error-rate-403-tracker
description: Use when tracking HTTP 403 rate per upstream — high rate indicates token/auth/IP block.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# error-rate-403-tracker

## Cuándo usarla
Use when tracking HTTP 403 rate per upstream — high rate indicates token/auth/IP block.
