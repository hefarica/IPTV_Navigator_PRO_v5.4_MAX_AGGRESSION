---
name: error-rate-404-tracker
description: Use when tracking HTTP 404 rate — high rate indicates segment expiry / playlist desync.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# error-rate-404-tracker

## Cuándo usarla
Use when tracking HTTP 404 rate — high rate indicates segment expiry / playlist desync.
