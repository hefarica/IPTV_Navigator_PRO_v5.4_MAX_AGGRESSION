---
name: error-rate-5xx-tracker
description: Use when tracking HTTP 5xx rate — high rate indicates upstream overload.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# error-rate-5xx-tracker

## Cuándo usarla
Use when tracking HTTP 5xx rate — high rate indicates upstream overload.
