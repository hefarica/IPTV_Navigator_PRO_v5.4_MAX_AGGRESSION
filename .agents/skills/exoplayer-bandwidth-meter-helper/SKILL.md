---
name: exoplayer-bandwidth-meter-helper
description: Use when configuring DefaultBandwidthMeter with sliding window + initialBitrateEstimate.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# exoplayer-bandwidth-meter-helper

## Cuándo usarla
Use when configuring DefaultBandwidthMeter with sliding window + initialBitrateEstimate.
