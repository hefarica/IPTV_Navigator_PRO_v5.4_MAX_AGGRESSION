---
name: exoplayer-load-control-tuner
description: Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="exoplayer.load_control",VALUE="{...}"` with minBufferMs/bufferForPlaybackMs.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# exoplayer-load-control-tuner

## Cuándo usarla
Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="exoplayer.load_control",VALUE="{...}"` with minBufferMs/bufferForPlaybackMs.
