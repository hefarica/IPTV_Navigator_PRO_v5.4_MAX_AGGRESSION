---
name: exoplayer-mediacodec-logger-parser
description: Use when parsing logcat MediaCodecLogger entries to extract resolution/codec/decoder_type/dropped_frames.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# exoplayer-mediacodec-logger-parser

## Cuándo usarla
Use when parsing logcat MediaCodecLogger entries to extract resolution/codec/decoder_type/dropped_frames.
