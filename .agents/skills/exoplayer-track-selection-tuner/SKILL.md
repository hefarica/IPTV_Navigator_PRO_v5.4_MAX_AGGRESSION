---
name: exoplayer-track-selection-tuner
description: Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="exoplayer.track_selection",VALUE="{...}"` for ABR caída libre.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# exoplayer-track-selection-tuner

## Cuándo usarla
Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="exoplayer.track_selection",VALUE="{...}"` for ABR caída libre.
