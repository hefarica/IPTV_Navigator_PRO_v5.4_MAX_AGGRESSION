---
name: ext-x-bitrate-emitter
description: Use when emitting `#EXT-X-BITRATE:N` (kbps) per-segment to inform ABR before fetching.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# ext-x-bitrate-emitter

## Cuándo usarla
Use when emitting `#EXT-X-BITRATE:N` (kbps) per-segment to inform ABR before fetching.
