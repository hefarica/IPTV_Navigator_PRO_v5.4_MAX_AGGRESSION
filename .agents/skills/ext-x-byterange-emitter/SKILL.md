---
name: ext-x-byterange-emitter
description: Use when emitting `#EXT-X-BYTERANGE:LEN[@OFFSET]` for sub-range segment fetches from a single resource.
specialist: S1
kind: satellite
parent: hls-rfc8216-media-playlist-builder
---

# ext-x-byterange-emitter

## Cuándo usarla
Use when emitting `#EXT-X-BYTERANGE:LEN[@OFFSET]` for sub-range segment fetches from a single resource.
