---
name: ext-x-content-steering-builder
description: Use when emitting `#EXT-X-CONTENT-STEERING:SERVER-URI="...",PATHWAY-ID="..."` for multi-CDN steering.
specialist: S1
kind: satellite
parent: hls-rfc8216-master-playlist-builder
---

# ext-x-content-steering-builder

## Cuándo usarla
Use when emitting `#EXT-X-CONTENT-STEERING:SERVER-URI="...",PATHWAY-ID="..."` for multi-CDN steering.
