---
name: ext-x-daterange-emitter
description: Use when emitting `#EXT-X-DATERANGE` for ad markers, SCTE-35 splice cues, or EPG windows.
specialist: S1
kind: satellite
parent: hls-rfc8216-media-playlist-builder
---

# ext-x-daterange-emitter

## Cuándo usarla
Use when emitting `#EXT-X-DATERANGE` for ad markers, SCTE-35 splice cues, or EPG windows.
