---
name: ext-x-discontinuity-sequence-tracker
description: Use when emitting `#EXT-X-DISCONTINUITY-SEQUENCE` after sliding-window playlist roll where discontinuities have left the window.
specialist: S1
kind: satellite
parent: hls-rfc8216-media-playlist-builder
---

# ext-x-discontinuity-sequence-tracker

## Cuándo usarla
Use when emitting `#EXT-X-DISCONTINUITY-SEQUENCE` after sliding-window playlist roll where discontinuities have left the window.
