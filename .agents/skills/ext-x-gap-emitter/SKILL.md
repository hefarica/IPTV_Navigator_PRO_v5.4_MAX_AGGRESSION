---
name: ext-x-gap-emitter
description: Use when emitting `#EXT-X-GAP` for missing segments to let players skip without throwing.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when emitting `#EXT-X-GAP` for missing segments to let players skip without throwing.
