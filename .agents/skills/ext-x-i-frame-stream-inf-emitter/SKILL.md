---
name: ext-x-i-frame-stream-inf-emitter
description: Use when emitting `#EXT-X-I-FRAME-STREAM-INF` for trick-play seek thumbnails in a master playlist.
specialist: S1
kind: satellite
parent: hls-rfc8216-master-playlist-builder
---

# ext-x-i-frame-stream-inf-emitter

## Cuándo usarla
Use when emitting `#EXT-X-I-FRAME-STREAM-INF` for trick-play seek thumbnails in a master playlist.
