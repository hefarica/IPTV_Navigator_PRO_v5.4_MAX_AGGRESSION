---
name: ext-x-key-emitter
description: Use when emitting `#EXT-X-KEY:METHOD=AES-128|SAMPLE-AES|NONE` for HLS encryption.
specialist: S1
kind: satellite
...
## Cuándo usarla
Use when emitting `#EXT-X-KEY:METHOD=AES-128|SAMPLE-AES|NONE` for HLS encryption.
