---
name: ext-x-media-renditions-handler
description: Use when emitting `#EXT-X-MEDIA:TYPE=AUDIO|SUBTITLES|VIDEO|CLOSED-CAPTIONS,GROUP-ID=...,NAME=...,URI=...` alternates.
specialist: S1
kind: satellite
parent: hls-rfc8216-master-playlist-builder
---

# ext-x-media-renditions-handler

## Cuándo usarla
Use when emitting `#EXT-X-MEDIA:TYPE=AUDIO|SUBTITLES|VIDEO|CLOSED-CAPTIONS,GROUP-ID=...,NAME=...,URI=...` alternates.
...
## Anchor skill
Sub-skill of: **hls-rfc8216-master-playlist-builder** (ver `.agents/skills/hls-rfc8216-master-playlist-builder/SKILL.md` para el marco completo).
...
Hereda del anchor `hls-rfc8216-master-playlist-builder` y del set permitido por la doctrina IPTV.
...
## Métricas que mejora
Sub-set de las métricas del anchor `hls-rfc8216-master-playlist-builder` (QoE composite, error rate, compatibilidad player).
