---
name: ext-x-media-sequence-tracker
description: Use when emitting / validating `#EXT-X-MEDIA-SEQUENCE` monotonicity across reload polls.
specialist: S1
kind: satellite
parent: hls-rfc8216-media-playlist-builder
---

# ext-x-media-sequence-tracker

## Cuándo usarla
Use when emitting / validating `#EXT-X-MEDIA-SEQUENCE` monotonicity across reload polls.
