---
name: ext-x-part-emitter
description: Use when emitting `#EXT-X-PART:DURATION=...,URI=...,INDEPENDENT=YES|NO` partial segments in LL-HLS media playlist.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when emitting `#EXT-X-PART:DURATION=...,URI=...,INDEPENDENT=YES|NO` partial segments in LL-HLS media playlist.
