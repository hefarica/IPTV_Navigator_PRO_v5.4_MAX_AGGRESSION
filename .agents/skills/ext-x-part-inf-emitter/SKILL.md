---
name: ext-x-part-inf-emitter
description: Use when emitting `#EXT-X-PART-INF:PART-TARGET=...` to declare partial segment target duration.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when emitting `#EXT-X-PART-INF:PART-TARGET=...` to declare partial segment target duration.
