---
name: ext-x-preload-hint-emitter
description: Use when emitting `#EXT-X-PRELOAD-HINT:TYPE=PART|MAP,URI=...,BYTERANGE-START=...` for partial/map prefetch.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# ext-x-preload-hint-emitter

## Cuándo usarla
Use when emitting `#EXT-X-PRELOAD-HINT:TYPE=PART|MAP,URI=...,BYTERANGE-START=...` for partial/map prefetch.
