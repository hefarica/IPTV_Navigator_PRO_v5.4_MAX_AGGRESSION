---
name: ext-x-rendition-report-emitter
description: Use when emitting `#EXT-X-RENDITION-REPORT:URI=...,LAST-MSN=...,LAST-PART=...` for cross-rendition sync.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# ext-x-rendition-report-emitter

## Cuándo usarla
Use when emitting `#EXT-X-RENDITION-REPORT:URI=...,LAST-MSN=...,LAST-PART=...` for cross-rendition sync.
