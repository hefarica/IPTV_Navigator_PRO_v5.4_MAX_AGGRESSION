---
name: ext-x-session-data-emitter
description: Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="reverse.dns.id",VALUE="..."` metadata in master playlists.
specialist: S1
kind: satellite
parent: hls-rfc8216-master-playlist-builder
---

# ext-x-session-data-emitter

## Cuándo usarla
Use when emitting `#EXT-X-SESSION-DATA:DATA-ID="reverse.dns.id",VALUE="..."` metadata in master playlists.
