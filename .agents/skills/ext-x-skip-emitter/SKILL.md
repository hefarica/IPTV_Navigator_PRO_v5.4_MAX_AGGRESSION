---
name: ext-x-skip-emitter
description: Use when emitting `#EXT-X-SKIP:SKIPPED-SEGMENTS=N` in delta playlists for LL-HLS.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when emitting `#EXT-X-SKIP:SKIPPED-SEGMENTS=N` in delta playlists for LL-HLS.
