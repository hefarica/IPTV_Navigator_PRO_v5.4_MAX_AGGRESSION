---
name: ext-x-stream-inf-builder
description: Use when emitting `#EXT-X-STREAM-INF:BANDWIDTH=...,RESOLUTION=...,CODECS="..."` in a master playlist.
specialist: S1
kind: satellite
parent: hls-rfc8216-master-playlist-builder
---

# ext-x-stream-inf-builder

## Cuándo usarla
Use when emitting `#EXT-X-STREAM-INF:BANDWIDTH=...,RESOLUTION=...,CODECS="..."` in a master playlist.
