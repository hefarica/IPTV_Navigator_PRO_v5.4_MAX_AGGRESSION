---
name: ext-x-targetduration-validator
description: Use when validating that no `#EXTINF:N` exceeds the declared `#EXT-X-TARGETDURATION`.
specialist: S1
kind: satellite
parent: hls-rfc8216-media-playlist-builder
---

# ext-x-targetduration-validator

## Cuándo usarla
Use when validating that no `#EXTINF:N` exceeds the declared `#EXT-X-TARGETDURATION`.
