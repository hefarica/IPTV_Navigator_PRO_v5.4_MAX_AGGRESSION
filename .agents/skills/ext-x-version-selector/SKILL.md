---
name: ext-x-version-selector
description: Use when picking `#EXT-X-VERSION:N` value (3 baseline, 6 for IFRAMES-ONLY, 7 for SAMPLE-AES, 8 for VARIABLE substitution, 9 for IMSC1 subs).
specialist: S1
kind: satellite
parent: iptv-hls-validator
---

# ext-x-version-selector

## Cuándo usarla
Use when picking `#EXT-X-VERSION:N` value (3 baseline, 6 for IFRAMES-ONLY, 7 for SAMPLE-AES, 8 for VARIABLE substitution, 9 for IMSC1 subs).
