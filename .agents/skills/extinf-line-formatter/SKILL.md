---
name: extinf-line-formatter
description: Use when formatting an `#EXTINF:-1 tvg-id="..." tvg-name="..." tvg-logo="..." group-title="...",CHANNEL_NAME` line per M3U Plus convention.
specialist: S1
kind: satellite
parent: m3u8-playlist-surgeon
---

# extinf-line-formatter

## Cuándo usarla
Use when formatting an `#EXTINF:-1 tvg-id="..." tvg-name="..." tvg-logo="..." group-title="...",CHANNEL_NAME` line per M3U Plus convention.
