---
name: extm3u-header-emitter
description: Use when emitting the first line `#EXTM3U` with M3U Plus attributes (x-tvg-url, refresh, catchup).
specialist: S1
kind: satellite
parent: m3u8-playlist-surgeon
---

# extm3u-header-emitter

## Cuándo usarla
Use when emitting the first line `#EXTM3U` with M3U Plus attributes (x-tvg-url, refresh, catchup).
