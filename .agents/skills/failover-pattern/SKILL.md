---
name: failover-pattern
description: Use when implementing failover between primary/backup upstreams on 5xx/timeout (NEVER on 403/429 per HTTP 407 doctrine).
specialist: S7
kind: satellite
...
## Cuándo usarla
Use when implementing failover between primary/backup upstreams on 5xx/timeout (NEVER on 403/429 per HTTP 407 doctrine).
