---
name: ffmpeg-ffprobe-validator
description: ffprobe-based codec/audio/bitrate analysis, segment integrity validation (ISOBMFF for fMP4, TS sync byte for MPEG-TS), audio loudness EBU R128, color space sanity, EBU/SCTE compliance smoke.
specialist: S12
kind: anchor
---

# ffmpeg-ffprobe-validator

## 1. Nombre de la skill
ffmpeg-ffprobe-validator

## 2. Cuándo usarla
ffprobe-based codec/audio/bitrate analysis, segment integrity validation (ISOBMFF for fMP4, TS sync byte for MPEG-TS), audio loudness EBU R128, color space sanity, EBU/SCTE compliance smoke.

Anchored to specialist: **QA Broadcast Validator** (S-tag S12).
Mission: FFmpeg, FFprobe, ISOBMFF inspection, EBU R128, SCTE compliance
