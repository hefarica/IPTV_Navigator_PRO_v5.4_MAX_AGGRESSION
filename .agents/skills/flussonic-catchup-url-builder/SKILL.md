---
name: flussonic-catchup-url-builder
description: Use when building Flussonic catchup URLs `?utc={utc}&lutc={lutc}` for time-shift / DVR replay.
specialist: S1
kind: satellite
parent: extinf-line-formatter
---

# flussonic-catchup-url-builder

## Cuándo usarla
Use when building Flussonic catchup URLs `?utc={utc}&lutc={lutc}` for time-shift / DVR replay.
