---
name: frame-rate-integrity-analyzer
description: Use when analyzing frame rate stability over a 60s window (no dropped frames, no duplicates beyond threshold).
specialist: S3
kind: satellite
parent: ffmpeg-ffprobe-validator
---

# frame-rate-integrity-analyzer

## Cuándo usarla
Use when analyzing frame rate stability over a 60s window (no dropped frames, no duplicates beyond threshold).
