---
name: gop-structure-analyzer
description: Use when analyzing GOP structure (open/closed, IDR cadence, B-frame depth) for ABR switching quality.
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when analyzing GOP structure (open/closed, IDR cadence, B-frame depth) for ABR switching quality.
