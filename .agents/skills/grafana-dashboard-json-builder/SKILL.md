...
description: Use when generating Grafana dashboard JSON (panels: throughput, TTFB, error rate, stall count, MOS).
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when generating Grafana dashboard JSON (panels: throughput, TTFB, error rate, stall count, MOS).
