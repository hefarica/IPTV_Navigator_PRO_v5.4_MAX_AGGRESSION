---
name: group-title-categorizer
description: Use when normalizing group-title into canonical categories (Deportes/Cine/Noticias/Infantil/Música/Adultos/Internacional).
specialist: S1
kind: satellite
parent: extinf-line-formatter
---

# group-title-categorizer

## Cuándo usarla
Use when normalizing group-title into canonical categories (Deportes/Cine/Noticias/Infantil/Música/Adultos/Internacional).
...
## Anchor skill
Sub-skill of: **extinf-line-formatter** (ver `.agents/skills/extinf-line-formatter/SKILL.md` para el marco completo).
...
Hereda del anchor `extinf-line-formatter` y del set permitido por la doctrina IPTV.
...
## Métricas que mejora
Sub-set de las métricas del anchor `extinf-line-formatter` (QoE composite, error rate, compatibilidad player).
