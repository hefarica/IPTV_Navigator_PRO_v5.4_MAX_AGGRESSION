---
name: h2-stream-multiplexing
description: Use when leveraging HTTP/2 stream multiplexing for concurrent segment fetches over single TCP connection.
specialist: S8
kind: satellite
parent: vps-network-tcp-quic-tuning
---

# h2-stream-multiplexing

## Cuándo usarla
Use when leveraging HTTP/2 stream multiplexing for concurrent segment fetches over single TCP connection.
