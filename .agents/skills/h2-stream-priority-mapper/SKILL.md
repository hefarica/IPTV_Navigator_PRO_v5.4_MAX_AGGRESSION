---
name: h2-stream-priority-mapper
description: Use when mapping HLS playlist vs segment fetches to HTTP/2 stream priorities (playlist HIGH, segments NORMAL).
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# h2-stream-priority-mapper

## Cuándo usarla
Use when mapping HLS playlist vs segment fetches to HTTP/2 stream priorities (playlist HIGH, segments NORMAL).
