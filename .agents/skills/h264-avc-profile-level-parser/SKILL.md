---
name: h264-avc-profile-level-parser
description: Use when parsing H.264 SPS to extract profile_idc / level_idc and build `avc1.PPCCLL` codec string.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# h264-avc-profile-level-parser

## Cuándo usarla
Use when parsing H.264 SPS to extract profile_idc / level_idc and build `avc1.PPCCLL` codec string.
