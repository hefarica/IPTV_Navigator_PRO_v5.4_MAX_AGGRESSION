---
name: h264-bitstream-sps-pps-extractor
description: Use when extracting H.264 SPS+PPS NAL units from a TS/fMP4 sample for codec_data injection.
specialist: S3
kind: satellite
parent: codec-quality-analyzer
---

# h264-bitstream-sps-pps-extractor

## Cuándo usarla
Use when extracting H.264 SPS+PPS NAL units from a TS/fMP4 sample for codec_data injection.
