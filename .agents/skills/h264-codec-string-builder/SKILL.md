---
name: h264-codec-string-builder
description: Use when emitting `avc1.640028` (High@L4.0) / `avc1.4D4029` (Main@L4.1) etc per Apple HLS guide.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# h264-codec-string-builder

## Cuándo usarla
Use when emitting `avc1.640028` (High@L4.0) / `avc1.4D4029` (Main@L4.1) etc per Apple HLS guide.
