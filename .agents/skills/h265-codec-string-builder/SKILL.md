---
name: h265-codec-string-builder
description: Use when emitting `hvc1.2.4.L153.B0` (Main10 @ L5.1) / `hvc1.1.6.L120.B0` (Main @ L4.0) etc. Profile.2=Main10, Profile.4=Main12, Profile.1=Main.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# h265-codec-string-builder

## Cuándo usarla
Use when emitting `hvc1.2.4.L153.B0` (Main10 @ L5.1) / `hvc1.1.6.L120.B0` (Main @ L4.0) etc. Profile.2=Main10, Profile.4=Main12, Profile.1=Main.
