---
name: h265-hevc-profile-level-parser
description: Use when parsing HEVC VPS/SPS to extract profile/tier/level/constraint flags for `hvc1.X.X.LXX.BX` string.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# h265-hevc-profile-level-parser

## Cuándo usarla
Use when parsing HEVC VPS/SPS to extract profile/tier/level/constraint flags for `hvc1.X.X.LXX.BX` string.
