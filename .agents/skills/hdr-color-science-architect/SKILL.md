---
name: hdr-color-science-architect
description: Use when designing HDR pipeline (HDR10/HDR10+/HLG/Dolby Vision) coherence between codec metadata, MPD/HLS attrs, player capabilities, and TV display.
specialist: S4
kind: anchor
---

# hdr-color-science-architect

## 1. Nombre de la skill
hdr-color-science-architect

## 2. Cuándo usarla
Use when designing HDR pipeline (HDR10/HDR10+/HLG/Dolby Vision) coherence between codec metadata, MPD/HLS attrs, player capabilities, and TV display.

Anchored to specialist: **Color Scientist HDR** (HDR/Color).
Mission: HDR10/HDR10+/HLG/Dolby Vision metadata, BT.2020/BT.709 coherence
