---
name: hdr-metadata-stripper-for-sdr-players
description: Use when stripping HDR metadata for SDR-only players to prevent display-side misinterpretation.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# hdr-metadata-stripper-for-sdr-players

## Cuándo usarla
Use when stripping HDR metadata for SDR-only players to prevent display-side misinterpretation.
