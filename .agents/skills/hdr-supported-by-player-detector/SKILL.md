---
name: hdr-supported-by-player-detector
description: Use when probing player/TV HDR capability (Media Capabilities API / system properties) before emitting HDR variants.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# hdr-supported-by-player-detector

## Cuándo usarla
Use when probing player/TV HDR capability (Media Capabilities API / system properties) before emitting HDR variants.
