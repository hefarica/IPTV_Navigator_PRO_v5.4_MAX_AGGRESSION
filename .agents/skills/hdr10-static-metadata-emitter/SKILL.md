---
name: hdr10-static-metadata-emitter
description: Use when emitting HDR10 SMPTE ST 2086 static metadata (mastering display primaries + max/min luminance) via SEI / `mdcv` box.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# hdr10-static-metadata-emitter

## Cuándo usarla
Use when emitting HDR10 SMPTE ST 2086 static metadata (mastering display primaries + max/min luminance) via SEI / `mdcv` box.
