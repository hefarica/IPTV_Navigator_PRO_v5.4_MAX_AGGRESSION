---
name: hdr10plus-dynamic-metadata-emitter
description: Use when emitting HDR10+ dynamic metadata (SMPTE ST 2094-40) via ITU-T T.35 user-data SEI NAL units per scene.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# hdr10plus-dynamic-metadata-emitter

## Cuándo usarla
Use when emitting HDR10+ dynamic metadata (SMPTE ST 2094-40) via ITU-T T.35 user-data SEI NAL units per scene.
