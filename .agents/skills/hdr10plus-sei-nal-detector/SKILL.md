---
name: hdr10plus-sei-nal-detector
description: Use when scanning H.265 SEI NAL for HDR10+ user_data_registered_itu_t_t35 with country_code=181 + provider_code.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# hdr10plus-sei-nal-detector

## Cuándo usarla
Use when scanning H.265 SEI NAL for HDR10+ user_data_registered_itu_t_t35 with country_code=181 + provider_code.
