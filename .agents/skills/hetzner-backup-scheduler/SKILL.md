---
name: hetzner-backup-scheduler
description: Use when scheduling Hetzner snapshot backups (weekly) + filesystem-level backups (daily via rsync to local).
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# hetzner-backup-scheduler

## Cuándo usarla
Use when scheduling Hetzner snapshot backups (weekly) + filesystem-level backups (daily via rsync to local).
