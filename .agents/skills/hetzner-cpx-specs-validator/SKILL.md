---
name: hetzner-cpx-specs-validator
description: Use when validating Hetzner CPX21 specs (3 vCPU AMD EPYC, 4 GB RAM, 40 GB SSD) match workload — upgrade to CCX23 for 4K transcode.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# hetzner-cpx-specs-validator

## Cuándo usarla
Use when validating Hetzner CPX21 specs (3 vCPU AMD EPYC, 4 GB RAM, 40 GB SSD) match workload — upgrade to CCX23 for 4K transcode.
