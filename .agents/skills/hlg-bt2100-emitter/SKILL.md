---
name: hlg-bt2100-emitter
description: Use when emitting BT.2100 HLG (Hybrid Log-Gamma) with transfer_characteristics=18 for broadcast HDR.
specialist: S4
kind: satellite
...
## Cuándo usarla
Use when emitting BT.2100 HLG (Hybrid Log-Gamma) with transfer_characteristics=18 for broadcast HDR.
