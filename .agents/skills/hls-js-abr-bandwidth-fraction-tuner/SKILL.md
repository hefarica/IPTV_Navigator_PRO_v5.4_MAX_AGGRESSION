---
name: hls-js-abr-bandwidth-fraction-tuner
description: Use when tuning hls.js abrBandWidthFactor (0.7-0.85 default; lower for pessimistic ABR).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# hls-js-abr-bandwidth-fraction-tuner

## Cuándo usarla
Use when tuning hls.js abrBandWidthFactor (0.7-0.85 default; lower for pessimistic ABR).
