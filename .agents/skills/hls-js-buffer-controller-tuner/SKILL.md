---
name: hls-js-buffer-controller-tuner
description: Use when tuning hls.js bufferController params (maxBufferLength, maxMaxBufferLength, maxBufferSize).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# hls-js-buffer-controller-tuner

## Cuándo usarla
Use when tuning hls.js bufferController params (maxBufferLength, maxMaxBufferLength, maxBufferSize).
