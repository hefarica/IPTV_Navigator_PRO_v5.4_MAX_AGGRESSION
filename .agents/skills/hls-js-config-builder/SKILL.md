---
name: hls-js-config-builder
description: Use when building hls.js config object (debug, lowLatencyMode, backBufferLength, maxBufferLength, abrBandWidthFactor).
specialist: S9
kind: satellite
...
## Cuándo usarla
Use when building hls.js config object (debug, lowLatencyMode, backBufferLength, maxBufferLength, abrBandWidthFactor).
