---
name: hls-js-error-handler
description: Use when handling hls.js error events (NETWORK_ERROR/MEDIA_ERROR/MUX_ERROR/OTHER_ERROR) with recovery strategies.
specialist: S9
kind: satellite
...
## Cuándo usarla
Use when handling hls.js error events (NETWORK_ERROR/MEDIA_ERROR/MUX_ERROR/OTHER_ERROR) with recovery strategies.
