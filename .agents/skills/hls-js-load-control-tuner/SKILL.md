---
name: hls-js-load-control-tuner
description: Use when tuning hls.js load control (maxLoadingDelay, fragLoadingMaxRetry, fragLoadingRetryDelay).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# hls-js-load-control-tuner

## Cuándo usarla
Use when tuning hls.js load control (maxLoadingDelay, fragLoadingMaxRetry, fragLoadingRetryDelay).
