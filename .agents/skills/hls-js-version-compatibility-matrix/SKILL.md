---
name: hls-js-version-compatibility-matrix
description: Use when checking which hls.js version supports which feature (LL-HLS v1.4+, CMAF v1.0+, EXT-X-CONTENT-STEERING v1.5+).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# hls-js-version-compatibility-matrix

## Cuándo usarla
Use when checking which hls.js version supports which feature (LL-HLS v1.4+, CMAF v1.0+, EXT-X-CONTENT-STEERING v1.5+).
