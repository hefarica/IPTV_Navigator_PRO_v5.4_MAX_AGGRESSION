---
name: hls-rfc8216-media-playlist-builder
description: Use when emitting an HLS media playlist (segments list) with EXTINF + URI lines and required EXT-X-TARGETDURATION / EXT-X-MEDIA-SEQUENCE.
specialist: S1
kind: satellite
parent: iptv-hls-validator
---

# hls-rfc8216-media-playlist-builder

## Cuándo usarla
Use when emitting an HLS media playlist (segments list) with EXTINF + URI lines and required EXT-X-TARGETDURATION / EXT-X-MEDIA-SEQUENCE.
