---
name: hsts-header-emitter
description: Use when emitting `Strict-Transport-Security: max-age=31536000; includeSubDomains` for HTTPS lock-in.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when emitting `Strict-Transport-Security: max-age=31536000; includeSubDomains` for HTTPS lock-in.
