---
name: hsts-strict-transport-security-emitter
description: Use when emitting `Strict-Transport-Security: max-age=31536000; includeSubDomains; preload` for HTTPS lock-in.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# hsts-strict-transport-security-emitter

## Cuándo usarla
Use when emitting `Strict-Transport-Security: max-age=31536000; includeSubDomains; preload` for HTTPS lock-in.
