---
name: http2-server-push-helper
description: Use when configuring HTTP/2 server push hints for LL-HLS partial segments to reduce RTT.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# http2-server-push-helper

## Cuándo usarla
Use when configuring HTTP/2 server push hints for LL-HLS partial segments to reduce RTT.
