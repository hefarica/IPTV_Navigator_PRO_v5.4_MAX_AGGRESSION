---
name: http3-quic-server-push-helper
description: Use when configuring HTTP/3 QUIC datagram push for LL-HLS chunks.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# http3-quic-server-push-helper

## Cuándo usarla
Use when configuring HTTP/3 QUIC datagram push for LL-HLS chunks.
