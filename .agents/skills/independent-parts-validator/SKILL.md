---
name: independent-parts-validator
description: Use when ensuring at least one INDEPENDENT=YES PART exists per CAN-BLOCK-RELOAD interval (IDR keyframe alignment).
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# independent-parts-validator

## Cuándo usarla
Use when ensuring at least one INDEPENDENT=YES PART exists per CAN-BLOCK-RELOAD interval (IDR keyframe alignment).
