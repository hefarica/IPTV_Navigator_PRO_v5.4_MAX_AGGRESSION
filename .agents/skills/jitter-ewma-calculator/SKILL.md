---
name: jitter-ewma-calculator
description: Use when computing RFC 3550-style jitter EWMA (delay variance) over throughput samples.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# jitter-ewma-calculator

## Cuándo usarla
Use when computing RFC 3550-style jitter EWMA (delay variance) over throughput samples.
