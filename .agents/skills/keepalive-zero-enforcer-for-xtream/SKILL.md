---
name: keepalive-zero-enforcer-for-xtream
description: Use when enforcing `keepalive 0` (or omitting upstream { keepalive N }) for Xtream upstreams with max_connections=1 to prevent session bleed.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# keepalive-zero-enforcer-for-xtream

## Cuándo usarla
Use when enforcing `keepalive 0` (or omitting upstream { keepalive N }) for Xtream upstreams with max_connections=1 to prevent session bleed.
