---
name: kernel-tuning-net-core
description: Use when tuning /etc/sysctl.d/99-streaming.conf (net.core.rmem_max, wmem_max, somaxconn, netdev_max_backlog).
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# kernel-tuning-net-core

## Cuándo usarla
Use when tuning /etc/sysctl.d/99-streaming.conf (net.core.rmem_max, wmem_max, somaxconn, netdev_max_backlog).
