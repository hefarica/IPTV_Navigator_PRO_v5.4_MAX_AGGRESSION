---
name: keyframe-interval-detector
description: Use when measuring keyframe interval (IDR cadence) to verify GOP size matches target_duration.
specialist: S3
kind: satellite
parent: ffmpeg-ffprobe-validator
---

# keyframe-interval-detector

## Cuándo usarla
Use when measuring keyframe interval (IDR cadence) to verify GOP size matches target_duration.
