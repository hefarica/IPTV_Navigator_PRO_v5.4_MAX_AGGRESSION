---
name: kodi-inputstream-adaptive-config-builder
description: Use when emitting #KODIPROP:inputstream.adaptive.* (manifest_type, stream_selection_type, min_bandwidth, max_bandwidth).
specialist: S9
kind: satellite
parent: android-tv-ott-tivimate-tuning
---

# kodi-inputstream-adaptive-config-builder

## Cuándo usarla
Use when emitting #KODIPROP:inputstream.adaptive.* (manifest_type, stream_selection_type, min_bandwidth, max_bandwidth).
