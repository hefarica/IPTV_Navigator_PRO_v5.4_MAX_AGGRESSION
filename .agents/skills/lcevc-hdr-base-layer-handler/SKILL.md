---
name: lcevc-hdr-base-layer-handler
description: Use when handling MPEG-5 LCEVC (Part 2) base layer + L1/L2 enhancement layers for HDR content.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# lcevc-hdr-base-layer-handler

## Cuándo usarla
Use when handling MPEG-5 LCEVC (Part 2) base layer + L1/L2 enhancement layers for HDR content.
