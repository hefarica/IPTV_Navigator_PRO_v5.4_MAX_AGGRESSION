...
description: Use when implementing genuine Low-Latency HLS with CMAF chunks, EXT-X-PART/PRELOAD-HINT/SERVER-CONTROL, blocking playlist reload, and segment/keyframe alignment.
specialist: S2
kind: anchor
---
...
## 2. Cuándo usarla
Use when implementing genuine Low-Latency HLS with CMAF chunks, EXT-X-PART/PRELOAD-HINT/SERVER-CONTROL, blocking playlist reload, and segment/keyframe alignment.
