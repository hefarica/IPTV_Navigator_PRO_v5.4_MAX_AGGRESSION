---
name: ll-hls-player-compat-matrix
description: Use when checking LL-HLS support across Safari/iOS, hls.js v1.4+, Shaka 4+, ExoPlayer 2.18+ before emitting LL-HLS tags.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# ll-hls-player-compat-matrix

## Cuándo usarla
Use when checking LL-HLS support across Safari/iOS, hls.js v1.4+, Shaka 4+, ExoPlayer 2.18+ before emitting LL-HLS tags.
