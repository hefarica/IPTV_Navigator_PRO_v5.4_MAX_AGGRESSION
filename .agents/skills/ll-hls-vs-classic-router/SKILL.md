---
name: ll-hls-vs-classic-router
description: Use when deciding whether a given playlist endpoint should be LL-HLS, classic HLS, M3U Plus channel list, or DASH — STRICT separation per RFC.
specialist: S2
kind: anchor
---

# ll-hls-vs-classic-router

## 1. Nombre de la skill
ll-hls-vs-classic-router

## 2. Cuándo usarla
Use when deciding whether a given playlist endpoint should be LL-HLS, classic HLS, M3U Plus channel list, or DASH — STRICT separation per RFC.

Anchored to specialist: **LL-HLS/CMAF Engineer** (LL-HLS/CMAF).
Mission: Low-Latency HLS, fMP4/CMAF, sub-2s glass-to-glass
