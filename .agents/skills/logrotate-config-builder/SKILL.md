---
name: logrotate-config-builder
description: Use when writing `/etc/logrotate.d/X` with daily / weekly / size= rotation + compress + postrotate signal.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# logrotate-config-builder

## Cuándo usarla
Use when writing `/etc/logrotate.d/X` with daily / weekly / size= rotation + compress + postrotate signal.
