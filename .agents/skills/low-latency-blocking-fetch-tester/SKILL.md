---
name: low-latency-blocking-fetch-tester
description: Use when testing blocking playlist reload returns 200 within PART-TARGET after the requested MSN/PART becomes available.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# low-latency-blocking-fetch-tester

## Cuándo usarla
Use when testing blocking playlist reload returns 200 within PART-TARGET after the requested MSN/PART becomes available.
