---
name: m3u8-playlist-surgeon
description: Use when refactoring monolithic M3U8 generators, deduplicating channels, normalizing EXTINF lines, or reordering by country/category/quality without breaking line count.
specialist: S1
kind: anchor
---

# m3u8-playlist-surgeon

## 1. Nombre de la skill
m3u8-playlist-surgeon

## 2. Cuándo usarla
Use when refactoring monolithic M3U8 generators, deduplicating channels, normalizing EXTINF lines, or reordering by country/category/quality without breaking line count.

Anchored to specialist: **IPTV/HLS Architect** (HLS/M3U8).
Mission: RFC 8216 compliance, M3U Plus emission, channel ordering, dedup
