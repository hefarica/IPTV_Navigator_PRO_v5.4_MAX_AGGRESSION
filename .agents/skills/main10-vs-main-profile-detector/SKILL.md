---
name: main10-vs-main-profile-detector
description: Use when distinguishing HEVC Main10 (profile 2, 10-bit) vs Main (profile 1, 8-bit) before declaring HDR capability.
specialist: S3
kind: satellite
parent: codec-quality-analyzer
---

# main10-vs-main-profile-detector

## Cuándo usarla
Use when distinguishing HEVC Main10 (profile 2, 10-bit) vs Main (profile 1, 8-bit) before declaring HDR capability.
