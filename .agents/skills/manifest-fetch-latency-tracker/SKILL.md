---
name: manifest-fetch-latency-tracker
description: Use when tracking manifest fetch latency per upstream + status code (200/304/4xx/5xx).
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# manifest-fetch-latency-tracker

## Cuándo usarla
Use when tracking manifest fetch latency per upstream + status code (200/304/4xx/5xx).
