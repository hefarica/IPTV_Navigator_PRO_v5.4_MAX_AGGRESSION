---
name: mastering-display-metadata-emitter
description: Use when emitting mastering display primaries (RGB+white point coordinates) per SMPTE ST 2086.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# mastering-display-metadata-emitter

## Cuándo usarla
Use when emitting mastering display primaries (RGB+white point coordinates) per SMPTE ST 2086.
