---
name: matrix-coefficients-emitter
description: Use when emitting matrix_coefficients (bt709 / bt2020nc / bt2020c) for color decoding.
specialist: S3
kind: satellite
parent: codec-quality-analyzer
---

# matrix-coefficients-emitter

## Cuándo usarla
Use when emitting matrix_coefficients (bt709 / bt2020nc / bt2020c) for color decoding.
