---
name: max-fall-emitter
description: Use when emitting MaxFALL (Maximum Frame-Average Light Level) in HDR10 static metadata (cd/m² average).
specialist: S4
kind: satellite
...
## Cuándo usarla
Use when emitting MaxFALL (Maximum Frame-Average Light Level) in HDR10 static metadata (cd/m² average).
