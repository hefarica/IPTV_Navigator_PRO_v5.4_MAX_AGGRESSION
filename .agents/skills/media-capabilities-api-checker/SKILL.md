---
name: media-capabilities-api-checker
description: Use when calling `navigator.mediaCapabilities.decodingInfo({type, video, audio})` to check codec/resolution/framerate/HDR support.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# media-capabilities-api-checker

## Cuándo usarla
Use when calling `navigator.mediaCapabilities.decodingInfo({type, video, audio})` to check codec/resolution/framerate/HDR support.
