---
name: mos-score-mapper
description: Use when mapping QoE composite to MOS (Mean Opinion Score 1-5) per ITU-T P.1203.
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when mapping QoE composite to MOS (Mean Opinion Score 1-5) per ITU-T P.1203.
