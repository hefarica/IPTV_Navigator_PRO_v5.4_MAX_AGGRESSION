---
name: mse-codec-supported-check
description: Use when calling `MediaSource.isTypeSupported('video/mp4; codecs="..."')` to verify codec before requesting variant.
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# mse-codec-supported-check

## Cuándo usarla
Use when calling `MediaSource.isTypeSupported('video/mp4; codecs="..."')` to verify codec before requesting variant.
