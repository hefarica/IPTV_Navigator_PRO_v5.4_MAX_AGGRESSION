---
name: mtu-anycast-anyaddr-discovery
description: Use when probing MTU per anycast destination via packetdrill / scapy fragmentation tests.
specialist: S8
kind: satellite
parent: vps-network-tcp-quic-tuning
---

# mtu-anycast-anyaddr-discovery

## Cuándo usarla
Use when probing MTU per anycast destination via packetdrill / scapy fragmentation tests.
