---
name: ocsp-stapling-helper
description: Use when enabling `ssl_stapling on; ssl_stapling_verify on;` to reduce TLS handshake latency.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when enabling `ssl_stapling on; ssl_stapling_verify on;` to reduce TLS handshake latency.
