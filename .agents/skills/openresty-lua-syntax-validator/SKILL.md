---
name: openresty-lua-syntax-validator
description: Use when validating Lua module syntax with `luac -p file.lua` before nginx reload.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# openresty-lua-syntax-validator

## Cuándo usarla
Use when validating Lua module syntax with `luac -p file.lua` before nginx reload.
