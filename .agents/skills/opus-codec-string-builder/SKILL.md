---
name: opus-codec-string-builder
description: Use when emitting `opus` codec string for Opus audio in fMP4/CMAF.
specialist: S3
kind: satellite
parent: codec-rfc6381-string-validator
---

# opus-codec-string-builder

## Cuándo usarla
Use when emitting `opus` codec string for Opus audio in fMP4/CMAF.
