---
name: origin-cors-controlled-emitter
description: Use when emitting CORS Allow-Origin to specific authorized origins only (NEVER *) — prevents 3rd-party hotlink.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# origin-cors-controlled-emitter

## Cuándo usarla
Use when emitting CORS Allow-Origin to specific authorized origins only (NEVER *) — prevents 3rd-party hotlink.
