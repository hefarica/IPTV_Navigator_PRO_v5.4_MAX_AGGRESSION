---
name: ott-navigator-profile-builder
description: Use when building OTT Navigator profile (UA, codec preferences, buffer settings, HDR enable).
specialist: S9
kind: satellite
parent: android-tv-ott-tivimate-tuning
---

# ott-navigator-profile-builder

## Cuándo usarla
Use when building OTT Navigator profile (UA, codec preferences, buffer settings, HDR enable).
