---
name: packet-loss-pct-tracker
description: Use when computing packet loss % from TCP retransmits (ss -t) or QUIC packet number gaps.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# packet-loss-pct-tracker

## Cuándo usarla
Use when computing packet loss % from TCP retransmits (ss -t) or QUIC packet number gaps.
