---
name: part-hold-back-tuner
description: Use when tuning PART-HOLD-BACK (recommended ≥ 3× PART-TARGET) to balance latency vs reliability.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# part-hold-back-tuner

## Cuándo usarla
Use when tuning PART-HOLD-BACK (recommended ≥ 3× PART-TARGET) to balance latency vs reliability.
