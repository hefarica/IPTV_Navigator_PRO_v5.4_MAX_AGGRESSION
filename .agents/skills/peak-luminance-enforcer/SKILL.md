---
name: peak-luminance-enforcer
description: Use when enforcing peak luminance value (default 1000 nits, 4000 nits for high-end masters) in HDR metadata.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# peak-luminance-enforcer

## Cuándo usarla
Use when enforcing peak luminance value (default 1000 nits, 4000 nits for high-end masters) in HDR metadata.
