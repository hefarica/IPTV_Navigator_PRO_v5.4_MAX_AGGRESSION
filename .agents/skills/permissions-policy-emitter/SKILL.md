---
name: permissions-policy-emitter
description: Use when emitting `Permissions-Policy: camera=(), microphone=(), geolocation=()` to restrict browser features.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# permissions-policy-emitter

## Cuándo usarla
Use when emitting `Permissions-Policy: camera=(), microphone=(), geolocation=()` to restrict browser features.
