---
name: player-compatibility-matrix
description: Player profile matrix (OTT Navigator, TiviMate, hls.js, Shaka, VLC, Apple AVPlayer, ExoPlayer). Header behaviour per player, tag tolerance, ABR strategy.
specialist: S9
kind: anchor
---
...
## 2. Cuándo usarla
Player profile matrix (OTT Navigator, TiviMate, hls.js, Shaka, VLC, Apple AVPlayer, ExoPlayer). Header behaviour per player, tag tolerance, ABR strategy.

Anchored to specialist: **hls.js/MSE/Android TV Player Engineer** (S-tag S9).
Mission: Player-specific quirks, ABR tuning per stack, codec support detection
