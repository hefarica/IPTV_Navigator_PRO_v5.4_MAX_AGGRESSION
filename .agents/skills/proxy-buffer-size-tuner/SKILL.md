---
name: proxy-buffer-size-tuner
description: Use when tuning `proxy_buffer_size` (4k-16k typical; large enough for response headers).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-buffer-size-tuner

## Cuándo usarla
Use when tuning `proxy_buffer_size` (4k-16k typical; large enough for response headers).
