---
name: proxy-buffering-helper
description: Use when deciding `proxy_buffering on/off` (off for LL-HLS streaming, on for classic HLS).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-buffering-helper

## Cuándo usarla
Use when deciding `proxy_buffering on/off` (off for LL-HLS streaming, on for classic HLS).
