---
name: proxy-busy-buffers-size-tuner
description: Use when tuning `proxy_busy_buffers_size` to balance memory vs throughput.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-busy-buffers-size-tuner

## Cuándo usarla
Use when tuning `proxy_busy_buffers_size` to balance memory vs throughput.
