---
name: proxy-cache-bypass-helper
description: Use when configuring `proxy_cache_bypass` for ?nocache=1 / no-store / dynamic playlists.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-cache-bypass-helper

## Cuándo usarla
Use when configuring `proxy_cache_bypass` for ?nocache=1 / no-store / dynamic playlists.
