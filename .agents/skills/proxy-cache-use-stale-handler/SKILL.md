---
name: proxy-cache-use-stale-handler
description: Use when emitting `proxy_cache_use_stale error timeout updating http_500 http_502 http_503 http_504` for graceful degradation.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-cache-use-stale-handler

## Cuándo usarla
Use when emitting `proxy_cache_use_stale error timeout updating http_500 http_502 http_503 http_504` for graceful degradation.
