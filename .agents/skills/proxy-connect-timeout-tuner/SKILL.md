---
name: proxy-connect-timeout-tuner
description: Use when tuning `proxy_connect_timeout` (5s typical to fail fast on dead upstreams).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-connect-timeout-tuner

## Cuándo usarla
Use when tuning `proxy_connect_timeout` (5s typical to fail fast on dead upstreams).
