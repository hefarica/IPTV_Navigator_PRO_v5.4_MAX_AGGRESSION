---
name: proxy-read-timeout-tuner
description: Use when tuning `proxy_read_timeout` (60s minimum for IPTV; lower risks freeze on segment latency spike).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-read-timeout-tuner

## Cuándo usarla
Use when tuning `proxy_read_timeout` (60s minimum for IPTV; lower risks freeze on segment latency spike).
