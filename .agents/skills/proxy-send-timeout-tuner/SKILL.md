---
name: proxy-send-timeout-tuner
description: Use when tuning `proxy_send_timeout` (60s typical for upload-heavy LL-HLS).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# proxy-send-timeout-tuner

## Cuándo usarla
Use when tuning `proxy_send_timeout` (60s typical for upload-heavy LL-HLS).
