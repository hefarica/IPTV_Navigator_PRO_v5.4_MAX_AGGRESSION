---
name: psnr-score-estimator-from-metadata
description: Use when estimating PSNR dB from codec/bitrate/resolution heuristic.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# psnr-score-estimator-from-metadata

## Cuándo usarla
Use when estimating PSNR dB from codec/bitrate/resolution heuristic.
