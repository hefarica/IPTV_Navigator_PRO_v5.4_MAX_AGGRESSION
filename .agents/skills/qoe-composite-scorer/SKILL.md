---
name: qoe-composite-scorer
description: Use when computing composite QoE score (weights: startup 30%, rebuffer 40%, quality 20%, switches 10%) → 0-100.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# qoe-composite-scorer

## Cuándo usarla
Use when computing composite QoE score (weights: startup 30%, rebuffer 40%, quality 20%, switches 10%) → 0-100.
