---
name: qoe-observability-engine
description: Use when instrumenting end-to-end QoE telemetry: startup time, rebuffering ratio, stall count, bitrate switches, VMAF/SSIM/PSNR estimates, MOS score.
specialist: S5
kind: anchor
---

# qoe-observability-engine

## 1. Nombre de la skill
qoe-observability-engine

## 2. Cuándo usarla
Use when instrumenting end-to-end QoE telemetry: startup time, rebuffering ratio, stall count, bitrate switches, VMAF/SSIM/PSNR estimates, MOS score.

Anchored to specialist: **QoE/QoS Researcher** (QoE/Telemetry).
Mission: Startup time, rebuffer ratio, stall count, VMAF/SSIM estimates, MOS
