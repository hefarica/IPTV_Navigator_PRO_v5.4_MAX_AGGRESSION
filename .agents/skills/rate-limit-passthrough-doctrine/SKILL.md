---
name: rate-limit-passthrough-doctrine
description: Use when REMOVING aggressive rate limits in single-user IPTV scenarios per autopista doctrine — performance > protection.
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# rate-limit-passthrough-doctrine

## Cuándo usarla
Use when REMOVING aggressive rate limits in single-user IPTV scenarios per autopista doctrine — performance > protection.
