---
name: rebuffering-ratio-calculator
description: Use when computing rebuffer ratio = total_stall_time / total_play_time (target <0.5%).
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# rebuffering-ratio-calculator

## Cuándo usarla
Use when computing rebuffer ratio = total_stall_time / total_play_time (target <0.5%).
