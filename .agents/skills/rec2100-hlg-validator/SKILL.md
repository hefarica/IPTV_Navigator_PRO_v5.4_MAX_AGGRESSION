---
name: rec2100-hlg-validator
description: Use when validating BT.2100 HLG signaling: color_primaries=9, transfer_characteristics=18, matrix_coefficients=9.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# rec2100-hlg-validator

## Cuándo usarla
Use when validating BT.2100 HLG signaling: color_primaries=9, transfer_characteristics=18, matrix_coefficients=9.
