---
name: rec2100-pq-validator
description: Use when validating BT.2100 PQ signaling: color_primaries=9, transfer_characteristics=16, matrix_coefficients=9.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# rec2100-pq-validator

## Cuándo usarla
Use when validating BT.2100 PQ signaling: color_primaries=9, transfer_characteristics=16, matrix_coefficients=9.
