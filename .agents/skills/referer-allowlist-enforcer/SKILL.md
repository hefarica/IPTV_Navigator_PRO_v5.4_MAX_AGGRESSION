---
name: referer-allowlist-enforcer
description: Use when enforcing Referer allowlist (netflix.com, channel-specific domains) per upstream license terms.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# referer-allowlist-enforcer

## Cuándo usarla
Use when enforcing Referer allowlist (netflix.com, channel-specific domains) per upstream license terms.
