---
name: referrer-policy-emitter
description: Use when emitting `Referrer-Policy: no-referrer` or `strict-origin-when-cross-origin` to control referrer leakage.
specialist: S10
kind: satellite
parent: secure-header-profiler
---

# referrer-policy-emitter

## Cuándo usarla
Use when emitting `Referrer-Policy: no-referrer` or `strict-origin-when-cross-origin` to control referrer leakage.
