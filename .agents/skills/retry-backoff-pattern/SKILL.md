...
description: Use when implementing exponential backoff (base 2s, cap 60s) with jitter for retry loops.
specialist: S7
kind: satellite
...
## Cuándo usarla
Use when implementing exponential backoff (base 2s, cap 60s) with jitter for retry loops.
