---
name: sbom-generator
description: Use when generating SBOM (CycloneDX / SPDX) via syft / cyclonedx-bom for supply-chain audit.
specialist: S10
kind: satellite
...
## Cuándo usarla
Use when generating SBOM (CycloneDX / SPDX) via syft / cyclonedx-bom for supply-chain audit.
