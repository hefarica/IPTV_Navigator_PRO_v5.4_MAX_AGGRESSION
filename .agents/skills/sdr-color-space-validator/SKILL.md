---
name: sdr-color-space-validator
description: Use when validating SDR streams stay in BT.709/sRGB and don't accidentally carry BT.2020 metadata.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# sdr-color-space-validator

## Cuándo usarla
Use when validating SDR streams stay in BT.709/sRGB and don't accidentally carry BT.2020 metadata.
