...
description: Use when installing pre-commit hook running gitleaks / trufflehog / detect-secrets to block accidental commits with API keys.
specialist: S10
kind: satellite
...
## Cuándo usarla
Use when installing pre-commit hook running gitleaks / trufflehog / detect-secrets to block accidental commits with API keys.
