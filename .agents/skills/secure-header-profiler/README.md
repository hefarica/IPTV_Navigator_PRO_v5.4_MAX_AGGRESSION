...
## Propósito
Use when designing header sanitization layer: block toxic headers (Range/If-None-Match/TE/Priority/Upgrade-Insecure-Requests) per player profile + per upstream.
