---
name: segment-fetch-latency-tracker
description: Use when tracking segment fetch latency p50/p95/p99 with payload size in same window.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# segment-fetch-latency-tracker

## Cuándo usarla
Use when tracking segment fetch latency p50/p95/p99 with payload size in same window.
