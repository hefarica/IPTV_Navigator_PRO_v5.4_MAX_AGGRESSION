---
name: segment-keyframe-alignment-checker
description: Use when verifying segment boundaries align with keyframes (IDR) for seek without artifacts.
specialist: S2
kind: satellite
parent: ll-hls-cmaf-engineer
---

# segment-keyframe-alignment-checker

## Cuándo usarla
Use when verifying segment boundaries align with keyframes (IDR) for seek without artifacts.
