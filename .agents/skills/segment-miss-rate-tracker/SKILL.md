---
name: segment-miss-rate-tracker
description: Use when computing segment miss rate (4xx + 5xx + EOF) over total segment fetches.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# segment-miss-rate-tracker

## Cuándo usarla
Use when computing segment miss rate (4xx + 5xx + EOF) over total segment fetches.
