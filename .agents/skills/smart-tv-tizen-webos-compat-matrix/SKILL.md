---
name: smart-tv-tizen-webos-compat-matrix
description: Use when validating Tizen (Samsung) and webOS (LG) Smart TV HLS support (CMAF mostly OK, LL-HLS spotty before 2023 models).
specialist: S9
kind: satellite
parent: player-compatibility-matrix
---

# smart-tv-tizen-webos-compat-matrix

## Cuándo usarla
Use when validating Tizen (Samsung) and webOS (LG) Smart TV HLS support (CMAF mostly OK, LL-HLS spotty before 2023 models).
