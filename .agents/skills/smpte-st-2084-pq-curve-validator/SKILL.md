---
name: smpte-st-2084-pq-curve-validator
description: Use when validating PQ (Perceptual Quantizer) EOTF curve = transfer_characteristics=16 per SMPTE ST 2084.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# smpte-st-2084-pq-curve-validator

## Cuándo usarla
Use when validating PQ (Perceptual Quantizer) EOTF curve = transfer_characteristics=16 per SMPTE ST 2084.
