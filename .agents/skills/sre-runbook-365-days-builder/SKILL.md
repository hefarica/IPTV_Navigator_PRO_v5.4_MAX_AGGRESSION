---
name: sre-runbook-365-days-builder
description: Use when writing operational runbook covering: deploy, rollback, common incidents, dashboards, on-call rotation.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# sre-runbook-365-days-builder

## Cuándo usarla
Use when writing operational runbook covering: deploy, rollback, common incidents, dashboards, on-call rotation.
