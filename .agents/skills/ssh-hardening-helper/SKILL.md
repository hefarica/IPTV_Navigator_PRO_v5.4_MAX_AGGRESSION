---
name: ssh-hardening-helper
description: Use when hardening sshd_config: PermitRootLogin no, PasswordAuthentication no, key-only auth, fail2ban for brute-force protection.
specialist: S7
kind: satellite
...
## Cuándo usarla
Use when hardening sshd_config: PermitRootLogin no, PasswordAuthentication no, key-only auth, fail2ban for brute-force protection.
