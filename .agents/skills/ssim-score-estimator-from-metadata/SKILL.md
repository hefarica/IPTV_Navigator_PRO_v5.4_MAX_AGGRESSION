---
name: ssim-score-estimator-from-metadata
description: Use when estimating SSIM (0-1) from codec/bitrate/resolution heuristic table.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# ssim-score-estimator-from-metadata

## Cuándo usarla
Use when estimating SSIM (0-1) from codec/bitrate/resolution heuristic table.
