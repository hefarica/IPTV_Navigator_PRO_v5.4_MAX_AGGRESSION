...
description: Use when measuring time-to-first-frame from manifest fetch start to first rendered video frame (target <2s).
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when measuring time-to-first-frame from manifest fetch start to first rendered video frame (target <2s).
