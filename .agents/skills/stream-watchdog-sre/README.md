...
## Propósito
Use when designing 365-day reliability watchdog: process/port/endpoint/channel health checks, auto-restart, backoff, circuit breaker, alert routing, status JSON.
