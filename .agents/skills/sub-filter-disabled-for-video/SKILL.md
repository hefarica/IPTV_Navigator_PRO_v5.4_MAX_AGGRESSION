---
name: sub-filter-disabled-for-video
description: Use when ensuring `sub_filter_types` does NOT include video/* (would corrupt fMP4/TS payload).
specialist: S6
kind: satellite
parent: nginx-openresty-streaming-proxy
---

# sub-filter-disabled-for-video

## Cuándo usarla
Use when ensuring `sub_filter_types` does NOT include video/* (would corrupt fMP4/TS payload).
