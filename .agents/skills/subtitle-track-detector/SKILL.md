---
name: subtitle-track-detector
description: Use when detecting WebVTT / TTML / IMSC1 / DVB-Sub / Closed-Captions tracks and emitting `#EXT-X-MEDIA TYPE=SUBTITLES`.
specialist: S3
kind: satellite
parent: ffmpeg-ffprobe-validator
---

# subtitle-track-detector

## Cuándo usarla
Use when detecting WebVTT / TTML / IMSC1 / DVB-Sub / Closed-Captions tracks and emitting `#EXT-X-MEDIA TYPE=SUBTITLES`.
