---
name: supplemental-codecs-dv-handler
description: Use when emitting `SUPPLEMENTAL-CODECS="dvh1.08.06"` attribute to declare Dolby Vision enhancement layer.
specialist: S4
kind: satellite
parent: hdr-color-science-architect
---

# supplemental-codecs-dv-handler

## Cuándo usarla
Use when emitting `SUPPLEMENTAL-CODECS="dvh1.08.06"` attribute to declare Dolby Vision enhancement layer.
