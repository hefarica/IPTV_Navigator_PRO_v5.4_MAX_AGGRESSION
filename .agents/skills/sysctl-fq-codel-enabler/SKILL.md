---
name: sysctl-fq-codel-enabler
description: Use when enabling fq_codel qdisc to combat bufferbloat on streaming uplink.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# sysctl-fq-codel-enabler

## Cuándo usarla
Use when enabling fq_codel qdisc to combat bufferbloat on streaming uplink.
