---
name: systemd-restart-on-failure-tuner
description: Use when tuning `Restart=on-failure RestartSec=10 StartLimitInterval=60 StartLimitBurst=3` for safe restart loops.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# systemd-restart-on-failure-tuner

## Cuándo usarla
Use when tuning `Restart=on-failure RestartSec=10 StartLimitInterval=60 StartLimitBurst=3` for safe restart loops.
