...
description: Use when writing `/etc/systemd/system/X.timer` with OnCalendar / OnBootSec / OnUnitActiveSec for scheduled jobs.
specialist: S7
kind: satellite
...
## Cuándo usarla
Use when writing `/etc/systemd/system/X.timer` with OnCalendar / OnBootSec / OnUnitActiveSec for scheduled jobs.
