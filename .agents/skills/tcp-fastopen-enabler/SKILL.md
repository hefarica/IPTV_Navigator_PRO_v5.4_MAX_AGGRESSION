---
name: tcp-fastopen-enabler
description: Use when enabling TCP Fast Open via `net.ipv4.tcp_fastopen=3` to save RTT on repeated connections.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when enabling TCP Fast Open via `net.ipv4.tcp_fastopen=3` to save RTT on repeated connections.
