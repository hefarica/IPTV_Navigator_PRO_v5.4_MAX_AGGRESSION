---
name: tcp-initrwnd-tuner
description: Use when tuning initrwnd (initial receive window) via `ip route change ... initrwnd 400` paired with initcwnd.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when tuning initrwnd (initial receive window) via `ip route change ... initrwnd 400` paired with initcwnd.
