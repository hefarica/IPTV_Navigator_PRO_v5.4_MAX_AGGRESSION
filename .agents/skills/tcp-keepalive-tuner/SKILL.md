---
name: tcp-keepalive-tuner
description: Use when tuning keepalive (tcp_keepalive_time=60, _intvl=10, _probes=3) for proxy long-lived connections.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when tuning keepalive (tcp_keepalive_time=60, _intvl=10, _probes=3) for proxy long-lived connections.
