---
name: tcp-syn-flood-protection
description: Use when enabling SYN cookies via `net.ipv4.tcp_syncookies=1` for DDoS resilience.
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when enabling SYN cookies via `net.ipv4.tcp_syncookies=1` for DDoS resilience.
