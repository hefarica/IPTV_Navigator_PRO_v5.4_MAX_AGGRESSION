---
name: telchemy-vstq-vsmq-tr101290-validator
description: Use when validating Telchemy VSTQ/VSMQ + ETSI TR 101 290 priority 1/2/3 for IPTV broadcast.
specialist: S5
kind: satellite
parent: qoe-observability-engine
---

# telchemy-vstq-vsmq-tr101290-validator

## Cuándo usarla
Use when validating Telchemy VSTQ/VSMQ + ETSI TR 101 290 priority 1/2/3 for IPTV broadcast.
