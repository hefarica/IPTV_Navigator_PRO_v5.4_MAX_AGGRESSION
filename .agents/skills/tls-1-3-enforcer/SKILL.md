---
name: tls-1-3-enforcer
description: Use when enforcing `ssl_protocols TLSv1.3;` (cipher choice auto-managed by OpenSSL 1.1.1+).
specialist: S8
kind: satellite
...
## Cuándo usarla
Use when enforcing `ssl_protocols TLSv1.3;` (cipher choice auto-managed by OpenSSL 1.1.1+).
