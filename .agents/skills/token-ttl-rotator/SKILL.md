---
name: token-ttl-rotator
description: Use when rotating tokens with TTL ≤24h and refreshing via signed refresh endpoint.
specialist: S10
kind: satellite
...
## Cuándo usarla
Use when rotating tokens with TTL ≤24h and refreshing via signed refresh endpoint.
