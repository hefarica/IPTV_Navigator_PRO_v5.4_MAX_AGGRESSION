---
name: ts-to-fmp4-repackager
description: Use when repackaging MPEG-TS segments to fMP4 in-place (Bento4 / shaka-packager / ffmpeg `-c copy -f mp4`).
specialist: S2
kind: satellite
...
## Cuándo usarla
Use when repackaging MPEG-TS segments to fMP4 in-place (Bento4 / shaka-packager / ffmpeg `-c copy -f mp4`).
