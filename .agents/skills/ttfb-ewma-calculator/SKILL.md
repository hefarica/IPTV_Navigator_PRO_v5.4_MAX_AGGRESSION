---
name: ttfb-ewma-calculator
description: Use when computing TTFB EWMA over rolling window to detect upstream slowdown.
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when computing TTFB EWMA over rolling window to detect upstream slowdown.
