---
name: ttfb-tracker
description: Use when measuring Time-To-First-Byte for playlist + segment fetches (target <100ms manifest, <500ms first segment).
specialist: S5
kind: satellite
...
## Cuándo usarla
Use when measuring Time-To-First-Byte for playlist + segment fetches (target <100ms manifest, <500ms first segment).
