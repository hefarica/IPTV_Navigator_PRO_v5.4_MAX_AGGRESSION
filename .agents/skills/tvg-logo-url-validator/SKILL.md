---
name: tvg-logo-url-validator
description: Use when validating tvg-logo URLs return 200 OK with image content-type and reasonable size (<500 KB).
specialist: S1
kind: satellite
...
## Cuándo usarla
Use when validating tvg-logo URLs return 200 OK with image content-type and reasonable size (<500 KB).
