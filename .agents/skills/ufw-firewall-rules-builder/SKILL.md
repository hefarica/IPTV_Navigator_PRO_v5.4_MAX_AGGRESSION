---
name: ufw-firewall-rules-builder
description: Use when configuring ufw rules: allow 22/443/80, deny inbound 8099 (internal API), allow outbound to upstreams.
specialist: S7
kind: satellite
parent: stream-watchdog-sre
---

# ufw-firewall-rules-builder

## Cuándo usarla
Use when configuring ufw rules: allow 22/443/80, deny inbound 8099 (internal API), allow outbound to upstreams.
