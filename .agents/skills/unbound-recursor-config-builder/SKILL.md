---
name: unbound-recursor-config-builder
description: Use when configuring unbound as local recursor with cache (msg-cache-size: 64m) + DNSSEC + access-control.
specialist: S8
kind: satellite
parent: vps-network-tcp-quic-tuning
---

# unbound-recursor-config-builder

## Cuándo usarla
Use when configuring unbound as local recursor with cache (msg-cache-size: 64m) + DNSSEC + access-control.
