---
name: user-agent-pool-rotator
description: Use when rotating User-Agent per request from authorized pool (VLC, Web0S TV, Mozilla) without spoofing in violation of provider ToS.
specialist: S10
kind: satellite
...
## Cuándo usarla
Use when rotating User-Agent per request from authorized pool (VLC, Web0S TV, Mozilla) without spoofing in violation of provider ToS.
