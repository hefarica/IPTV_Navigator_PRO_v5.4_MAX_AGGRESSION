---
name: vlc-extvlcopt-builder
description: Use when emitting #EXTVLCOPT:network-caching=N / http-reconnect / adaptive-minbw / adaptive-maxbw.
specialist: S9
kind: satellite
...
## Cuándo usarla
Use when emitting #EXTVLCOPT:network-caching=N / http-reconnect / adaptive-minbw / adaptive-maxbw.
