---
name: vp9-codec-string-builder
description: Use when emitting `vp09.02.10.10` (profile 2, level 1.0, 10-bit) per VP9 RFC.
specialist: S3
kind: satellite
...
## Cuándo usarla
Use when emitting `vp09.02.10.10` (profile 2, level 1.0, 10-bit) per VP9 RFC.
