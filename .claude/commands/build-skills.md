---
name: build-skills
description: Regenerar / extender skills library .agents/skills/ desde manifest
---

# /build-skills

## Resumen
Regenerar / extender skills library .agents/skills/ desde manifest

## Delegate to
**claude-code-repo-surgeon**

## Inputs esperados
Optional: skills_to_add (lista de nombres), specialist_assignments

## Outputs esperados
Skills generadas + skills_index.json actualizado + SKILLS_INSTALLATION_REPORT.md

## Validaciones obligatorias
JSON valid, 8 files + 3 dirs por skill, no secrets

## Production safety
Modifica solo .agents/. No toca producción.

## Flujo de ejecución
1. **Cortex init** (`iptv-cortex-init-mandatory`) — 5-layer scan antes de cualquier acción.
2. **Identificar specialist responsable** (`claude-code-repo-surgeon`).
...
Cuando el usuario explícitamente lo invoque (`/build-skills`) o cuando un task descripción matche el summary de este comando.
