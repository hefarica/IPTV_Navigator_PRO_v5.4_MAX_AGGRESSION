---
name: player-compat
description: Matrix de compatibilidad: ¿qué players soportan esta lista / variant / codec?
---

# /player-compat

## Resumen
Matrix de compatibilidad: ¿qué players soportan esta lista / variant / codec?

## Delegate to
**player-compatibility-engineer + video-codec-engineer + color-scientist-hdr**

## Inputs esperados
Required: m3u8_file or variant_spec. Optional: device_type

## Outputs esperados
Matrix table: hls.js v1.4 / ExoPlayer 2.18 / OTT Navigator / TiviMate / VLC / Safari iOS / Tizen / webOS = PASS|FAIL|CONDITIONAL

## Validaciones obligatorias
Codec string parse RFC 6381, HDR metadata coherence, LL-HLS player support detection
...
2. **Identificar specialist responsable** (`player-compatibility-engineer + video-codec-engineer + color-scientist-hdr`).
...
Cuando el usuario explícitamente lo invoque (`/player-compat`) o cuando un task descripción matche el summary de este comando.
