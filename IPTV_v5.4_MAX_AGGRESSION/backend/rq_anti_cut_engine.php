...
/**
 * ============================================================================
 * APE ANTI-CUT ENGINE v1.0 — ISP Strangulation + Cut Detection + Quality Lock
 * ============================================================================
 *
...
function rq_get_anti_cut_profile(string $profile): array {
    $profiles = [
        'P1' => [
            ...
            'parallel_segments'    => '4,6,8',
            'concurrent_downloads' => '4,6,8',
            ...
            'vlc_network_caching'  => 180000,
            'vlc_live_caching'     => 120000,
            'vlc_disc_caching'     => 300000,
            'vlc_file_caching'     => 300000,
        ],
        'P2' => [
            'label'                => 'P2-AGGRESSIVE',
            'target_duration'      => 1,
        ...
        'P4' => [
            ...
            'vlc_network_caching'  => 60000,
            'vlc_live_caching'     => 40000,
            'vlc_disc_caching'     => 90000,
            'vlc_file_caching'     => 90000,
        ],
        'P5' => [
            'label'                => 'P5-MINIMAL',
            'target_duration'      => 3,
            ...
            'prefetch_parallel'    => 25,
            'prefetch_strategy'    => 'NORMAL',
            'buffer_max'           => 60000,
            'buffer_target'        => 15000,
            'buffer_ms'            => 15000,
            'network_caching'      => 20000,
            'live_caching'         => 20000,
            'file_caching'         => 60000,
            ...
            'vlc_network_caching'  => 40000,
            'vlc_live_caching'     => 30000,
            'vlc_disc_caching'     => 60000,
            'vlc_file_caching'     => 60000,
        ],
    ];
...
function rq_anti_cut_isp_strangler(string $profile, int $ch_id, string $origin, string $session): array {
    ...
    $exthttp = [
        ...
        'X-HDR-Support'          => 'hdr10,hdr10+,dolby_vision,hlg',
