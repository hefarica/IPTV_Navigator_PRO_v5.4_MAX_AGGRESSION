...
def build_proxy_url(proxy_base: str, origin_url: str, uid: str,
    ...
    params = {
        ...
        'ext':     '.m3u8',       # Requerido para forzar evasión en demuxer de VLC
    }
...
def process_m3u8(input_path: str, output_path: str, proxy_base: str) -> None:
    ...
    if not verification_ok:
        print("  [!] ADVERTENCIA: Alg\u00fan canal no cumpli\u00f3 la regla estricta de 53 l\u00edneas.")
    ...
    if t_elapsed > 10:
        print(f"  [!] ADVERTENCIA: El procesamiento tardó {t_elapsed:.1f}s (límite: 10s)")
