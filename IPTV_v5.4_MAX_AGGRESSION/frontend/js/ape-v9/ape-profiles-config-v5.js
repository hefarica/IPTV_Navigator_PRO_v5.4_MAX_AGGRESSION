    ...
    const DEFAULT_PROFILES = {
        ...
        P0: {
            ...
            settings: {
                ...
                codec_primary: 'AV1',
                codec_fallback: 'HEVC',
                codec_priority: 'hevc,hev1,hvc1,h265,h.265,H265,H.265,h264,h.264,H264,avc,av1',
                // HDR — Máximo nivel
        ...
        P2: {
            ...
            settings: {
                ...
                codec_primary: 'HEVC',
                codec_fallback: 'HEVC',
                codec_priority: 'hevc,hev1,hvc1,h265,h.265,H265,H.265,h-265,MPEG-H,mpegh,x265,h264,h.264,H264,H.264,avc,AVC,avc1,x264,av1,av01,AV1,vp9,VP9',
                hdr_support: ['hdr10', 'hlg'],
                color_depth: 10,
                audio_channels: 6,
                hevc_tier: 'HIGH',
        ...
        P3: {
            ...
            settings: {
                ...
                codec_primary: 'HEVC',
                codec_fallback: 'H264',
                codec_priority: 'hevc,hev1,hvc1,h265,h.265,H265,H.265,h264,h.264,H264,avc,mpeg2',
                hdr_support: ['hdr10'],
                color_depth: 10,
                audio_channels: 6,
                hevc_tier: 'HIGH',
